...
try {
  ...
  console.error('   ❌ ES Modules failed:', (error as any).message);
}
...
try {
  ...
  console.error('   ❌ Dynamic imports failed:', (error as any).message);
}
...
try {
  ...
  console.error('   ❌ Fetch API test failed:', (error as any).message);
}
...
try {
  ...
  console.error('   ❌ Worker Threads failed:', (error as any).message);
}
...
try {
  ...
  console.error('   ❌ AbortController failed:', (error as any).message);
}
...
try {
  ...
  console.error('   ❌ Buffer API failed:', (error as any).message);
}
