...
CREATE INDEX emergency_contacts_patient_id_is_active_idx ON public.emergency_contacts USING btree (patientId, is_active);
...
CREATE INDEX idx_assignments_doctor_active_created ON public.patient_doctor_assignments USING btree (doctorId, is_active, created_at);
...
CREATE INDEX idx_assignments_patient_type_active ON public.patient_doctor_assignments USING btree (patientId, assignment_type, is_active);
...
CREATE INDEX idx_vitals_patient_time_type ON public.vital_readings USING btree (patientId, reading_time, vital_type_id);
...
CREATE INDEX idx_vitals_patient_type_time_desc ON public.vital_readings USING btree (patientId, vital_type_id, reading_time);
...
CREATE INDEX idx_vitals_time_patient ON public.vital_readings USING btree (reading_time, patientId);
...
CREATE INDEX patient_allergies_patient_id_is_active_idx ON public.patient_allergies USING btree (patientId, is_active);
...
CREATE INDEX vital_readings_patient_id_vital_type_id_reading_time ON public.vital_readings USING btree (patientId, vital_type_id, reading_time);
