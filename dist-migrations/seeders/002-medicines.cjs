...
exports.default = {
    up: async (queryInterface, Sequelize) => {
        ...
        const existingMedicines = await queryInterface.sequelize.query("SELECT COUNT(*) as count FROM medicines", { type: Sequelize.QueryTypes.SELECT });
...
//# sourceMappingURL=002-medicines.js.map