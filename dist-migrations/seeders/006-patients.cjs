...
exports.default = {
    up: async (queryInterface, Sequelize) => {
        ...
        try {
            ...
            const existingPatients = await queryInterface.sequelize.query("SELECT email FROM users WHERE email IN ('john.doe@healthapp.com', 'jane.smith@healthapp.com', 'michael.johnson@healthapp.com', 'sarah.brown@healthapp.com', 'david.wilson@healthapp.com')", { type: Sequelize.QueryTypes.SELECT, transaction });
            ...
            const doctors = await queryInterface.sequelize.query('SELECT id FROM doctors LIMIT 1', { type: Sequelize.QueryTypes.SELECT, transaction });
            if (doctors.length === 0) {
            ...
            const hashedPassword = await bcryptjs_1.default.hash('patient123', 12);
            ...
            await queryInterface.bulkInsert('patients', [
                ...
                },
                {
                    ...
                    next_appointment_date: '2024-01-28',
                    is_active: true,
                    created_at: new Date(),
                    updated_at: new Date()
                }
...
//# sourceMappingURL=006-patients.js.map