...
exports.default = {
    up: async (queryInterface, Sequelize) => {
        ...
        const existingTreatments = await queryInterface.sequelize.query("SELECT COUNT(*) as count FROM treatment_database", { type: Sequelize.QueryTypes.SELECT });
...
//# sourceMappingURL=005-treatments.js.map