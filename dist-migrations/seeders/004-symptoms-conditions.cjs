...
exports.default = {
    up: async (queryInterface, Sequelize) => {
        ...
        const existingConditions = await queryInterface.sequelize.query("SELECT COUNT(*) as count FROM symptoms_database", { type: Sequelize.QueryTypes.SELECT });
...
//# sourceMappingURL=004-symptoms-conditions.js.map