...
exports.default = {
    up: async (queryInterface, Sequelize) => {
        ...
        const tableExists = await queryInterface.sequelize.query("SELECT EXISTS (SELECT FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'clinics')", { type: Sequelize.QueryTypes.SELECT });
...
//# sourceMappingURL=010-create-clinics.js.map