...
exports.default = {
    async up(queryInterface, Sequelize) {
        ...
        const result = await queryInterface.sequelize.query("SELECT table_name FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'patient_provider_consent_history'");
        ...
        const providerResult = await queryInterface.sequelize.query("SELECT table_name FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'provider_change_history'");
...
//# sourceMappingURL=20250807040453-add-provider-linkage-and-consent-tracking.js.map