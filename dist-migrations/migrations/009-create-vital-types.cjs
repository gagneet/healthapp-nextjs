...
exports.default = {
    up: async (queryInterface, Sequelize) => {
        ...
        const existingRecords = await queryInterface.sequelize.query('SELECT COUNT(*) as count FROM vital_types', { type: queryInterface.sequelize.QueryTypes.SELECT });
...
//# sourceMappingURL=009-create-vital-types.js.map