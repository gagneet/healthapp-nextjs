...
exports.default = {
    up: async (queryInterface, Sequelize) => {
        ...
        const tableExists = await queryInterface.sequelize.query("SELECT table_name FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'payments'", { type: Sequelize.QueryTypes.SELECT });
...
//# sourceMappingURL=027-create-payments.js.map