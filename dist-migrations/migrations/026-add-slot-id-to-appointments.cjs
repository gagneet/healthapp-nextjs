...
exports.default = {
    up: async (queryInterface, Sequelize) => {
        ...
        const columnExists = await queryInterface.sequelize.query("SELECT column_name FROM information_schema.columns WHERE table_name = 'appointments' AND column_name = 'slot_id'", { type: Sequelize.QueryTypes.SELECT });
...
//# sourceMappingURL=026-add-slot-id-to-appointments.js.map