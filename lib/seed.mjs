// lib/seed.mjs - Prisma-based seeding for comprehensive healthcare test data
  ...
  try {
    ...
    await prisma.$transaction(async (tx) => {
      ...
      await tx.vital_templates.deleteMany({
        where: {
          id: {
            in: ['VITAL-2024-001', 'VITAL-2024-002', 'VITAL-2024-03', 'VITAL-2024-004'] // Use consistent IDs
          }
        }
      });
    });
