...
export async function seedComprehensiveHealthcareData() {
  ...
  try {
    ...
    const doctorProfiles = await prisma.doctors.createMany({
      data: [
        {
          id: 'doc-emily-rodriguez',
          user_id: '99999999-9999-9999-9999-999999999999',
          speciality_id: 'spec-internal-medicine',
      ...
      data: [
        {
          ...
          primary_doctor_id: 'doc-emily-rodriguez',
          height_cm: 165.0,
          weight_kg: 68.5,
          blood_type: 'A+',
          primary_language: 'en',
        ...
        },
        {
          ...
          organization_id: organization.id,
          primary_doctor_id: 'doc-robert-smith',
          height_cm: 162.0,
          weight_kg: 55.2,
          blood_type: 'B+',
          primary_language: 'en',
