 ...
 */
export async function generateHspId() {
    return generateBusinessId({
        prefix: 'HSP',
        tableName: 'hsps',
        fieldName: 'hsp_id'
 ...
 */
export function validateBusinessId(id, expectedPrefix) {
 ...
 */
export function parseBusinessId(id) {
 ...
 */
export async function generateBulkIds(count, type) {
    const results = [];
