...
export default {
  up: async (queryInterface: any, Sequelize: any) => {
    ...
    const assignmentIndexes = [
      {
        fields: ['patientId', 'assignment_type', 'is_active'],
        name: 'idx_assignments_patient_type_active',
        concurrently: true
      },
      {
        fields: ['doctorId', 'is_active', 'created_at'],
    ...
    const vitalIndexes = [
      {
        fields: ['patientId', 'reading_time', 'vital_type_id'],
